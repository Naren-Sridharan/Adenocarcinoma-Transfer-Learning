...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Visualize filter based activation using guided backprop using Visdom.')
    ...
    parser.add_argument('-l', '--layer', help='Layer number. Default 10.', nargs='?', type=int, const=10, default=10)
    parser.add_argument('-f', '--filter', help='Filter number. Default 5.', nargs='?', type=int, const=5, default=5)
